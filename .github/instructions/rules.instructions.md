---
description: Rules to follow for each task
applyTo: '**/*'
---

# Copilot Instructions — Travel Notes & Places Archive
...
- La información debe provenir de fuentes confiables. No se requiere citar fuente para cada oración, pero sí incluir un campo `fuente:` al final de cada sección de lugar con las referencias principales usadas.
...
Copilot debe insertar `[⚠ VERIFICAR]` cuando:
...
*Estas instrucciones aplican a todas las interacciones de GitHub Copilot en este repositorio. La riqueza narrativa y la precisión factual van de la mano.*
